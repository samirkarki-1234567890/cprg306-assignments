  ...
  return (
    <main className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        <Link href="/week-8">
          <button className="w-full py-6 bg-slate-700 rounded-xl text-lg font-medium hover:bg-teal-600 transition duration-300 shadow-lg">
            Week 8
          </button>
        </Link>
        <Link href="/week-10">
          <button className="w-full py-6 bg-slate-700 rounded-xl text-lg font-medium hover:bg-indigo-600 transition duration-300 shadow-lg">
            Week 10
          </button>
        </Link>
      </div>
